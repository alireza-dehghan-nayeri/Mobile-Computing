...
object SampleData {
    ...
    val carSample = listOf(
        Car(
            brand = "Toyota",
            brandImage = R.drawable.toyota_logo,
            model = "Supra MK4",
            year = 1994,
        ...
        Car(
            brand = "Nissan",
            brandImage = R.drawable.nissan_logo,
        ...
        Car(
            brand = "Mazda",
            brandImage = R.drawable.mazda_logo,
            model = "RX-7 FD",
            year = 1993,
        ...
        Car(
            brand = "Honda",
            brandImage = R.drawable.honda_logo,
            model = "NSX",
            year = 1990,
        ...
        Car(
            brand = "Subaru",
            brandImage = R.drawable.subaru_logo,
        ...
        Car(
            brand = "Mitsubishi",
            brandImage = R.drawable.mitsubishi_logo,
